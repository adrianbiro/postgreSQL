...
FROM
    (
         ...
         FROM cbp_naics_72_establishments -- toto neexistuje
         GROUP BY st
    )
    AS est
JOIN
...
ALTER TABLE teacher ADD CONSTRAINT id_key PRIMARY KEY (id);
...
FROM '/home/adrian/gits/practical-sql-2/Chapter_13/ice_cream_survey.csv'
...
FROM '/home/adrian/gits/practical-sql-2/Chapter_13/temperature_readings.csv'
WITH (FORMAT CSV, HEADER);
