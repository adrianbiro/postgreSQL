...
DELETE FROM "Track"
WHERE "MediaTypeId" = 1
RETURNING *; -- napis co sa zmazalo

-- zmazat vsetko z tab
DELETE FROM "Track"
--zmaz tabulku ako taku
DROP TABLE "Track"
--
-- 
...
-- pozor necha value autoincrement
SELECT * 
FROM car;
--truncate to riesi 
...
-- It Removes all the data reset the auto increment number.
-- TRUNCATE TABLE cannot activate a trigger because the operation does not log individual row deletions.
-- Faster in performance wise, because it doesn't keep any logs.
-- Rollback is possible.
-- Cannot use LIMIT and ORDER BY.
